...
import styles from './Reflective.css';
...
function Reflective({dashboard,dispatch}) {
  ...
  return (
    ...
    <Layout className={styles.layout}>
      <Sider width='150' collapsible collapsed={collapsed} onCollapse={modeSwitch} style = {{backgroundColor:'#fff',borderRight: '1px solid #e9e9e9' }}>
            ...
            mode={mode}
            theme="light"
            defaultSelectedKeys={['reflective']}
            inlineIndent="18px"
...
export default connect(mapStateToProps)(Reflective);
